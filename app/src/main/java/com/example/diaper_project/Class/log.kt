...
data class log(@SerializedName("cnt") var cnt: String, @SerializedName("time") var time: String, @SerializedName("inner_opened") var inner_opened:Number,
               ...
               @SerializedName("comment") var comment:String,  @SerializedName("created_by") var created_by:String , @SerializedName("modified_by") var modified_by:String, @SerializedName("id") var id:String? =null ) {
}